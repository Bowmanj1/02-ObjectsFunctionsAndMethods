...
def main():
    ...
    #better_draw_circles(rg.Point(0, 0), 4)
    #better_draw_circles(rg.Point(100, 100), 21)
    #even_better_draw_circles(rg.Point(0, 0), 37, 3, 'blue', 5)
    #even_better_draw_circles(rg.Point(-50, 200), 3, 90, 'blue', 1)
    even_better_draw_circles(rg.Point(-50, 200), 3, 90, 'blue', 1)
    even_better_draw_circles(rg.Point(-20, -120), 2, 140, 'red', 1)
    even_better_draw_circles(rg.Point(200, -120), 3, 60, 'yellow', 2)
    even_better_draw_circles(rg.Point(86, 128), 2, 136, 'green', 1)
    even_better_draw_circles(rg.Point(-250, 0), 2, 136, 'magenta', 1)
    window.update()
...
def even_better_draw_circles(point, radius_increase, amount, color, thick):
    turtle = rg.SimpleTurtle()
    ...
    for k in range(1, amount + 1):
        ...
        turtle.pen_down()
        turtle.draw_circle(radius_increase * k)
